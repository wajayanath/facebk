...
//        $this->withoutExceptionHandling();
    ...
    /** @test */
    public function a_user_id_and_status_is_requested_for_friend_request_responses()
    {
        $response = $this->actingAs($user = factory(\App\User::class)->create(), 'api')
            ->post('/api/friend-request-response', [
                'user_id' => '',
    ...
    /** @test */
    public function a_user_id_is_requested_for_ignoring_a_friend_request_responses()
    {
        $response = $this->actingAs($user = factory(\App\User::class)->create(), 'api')
            ->delete('/api/friend-request-response/delete', [
                'user_id' => '',
